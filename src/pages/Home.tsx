    ...
    <main className="bg-[#080d14] text-white">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-24 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl font-black leading-[1.05] tracking-tight sm:text-6xl lg:text-8xl">
              Drive Your
              <span className="block text-yellow-500">Dream Car.</span>
            </h1>

            {/* Description */}
            <p className="mt-7 max-w-2xl text-base leading-7 text-gray-300 sm:text-lg">
              Discover premium vehicles, exceptional service and a dealership
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="mt-4 text-3xl font-black sm:text-5xl">
              Your Journey To The
              <span className="text-yellow-500"> Perfect Car</span> Starts Here.
            </h2>

            <p className="mt-6 leading-7 text-gray-400">
              At JamesAutos, we make buying your next vehicle simple,
              transparent and enjoyable. Browse our collection, compare vehicles
          ...
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
              ...
              <p className="mt-4 max-w-xl text-gray-400">
                Discover some of the premium vehicles currently available at
                JamesAutos.
              </p>
            </div>
            ...
            {cars.map((car, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="mt-3 text-xl font-bold">{car.name}</h3>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            >
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-5xl">
                More Than Just
                <span className="text-yellow-500"> A Car Dealer.</span>
              </h2>

              <p className="mt-6 leading-7 text-gray-300">
                We believe purchasing a vehicle should be an exciting
                experience. Our team is committed to providing quality cars and
            ...
            >
              <div className="rounded-2xl border border-white/10 bg-black/50 p-7 text-center backdrop-blur-md">
                <Gauge size={34} className="mx-auto text-yellow-500" />

                <h3 className="mt-4 text-3xl font-black">10+</h3>

                <p className="mt-2 text-sm text-gray-400">Years Experience</p>
              </div>

              <div className="rounded-2xl border border-white/10 bg-black/50 p-7 text-center backdrop-blur-md">
                <Car size={34} className="mx-auto text-yellow-500" />

                <h3 className="mt-4 text-3xl font-black">500+</h3>

                <p className="mt-2 text-sm text-gray-400">Cars Sold</p>
              </div>

              <div className="rounded-2xl border border-white/10 bg-black/50 p-7 text-center backdrop-blur-md">
                <Star size={34} className="mx-auto text-yellow-500" />
              ...
              <div className="rounded-2xl border border-white/10 bg-black/50 p-7 text-center backdrop-blur-md">
                <ShieldCheck size={34} className="mx-auto text-yellow-500" />

                <h3 className="mt-4 text-3xl font-black">100%</h3>

                <p className="mt-2 text-sm text-gray-400">Verified Cars</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          <blockquote className="mt-7 text-2xl font-semibold leading-10 sm:text-3xl">
            "JamesAutos made buying my car incredibly easy. The team was
            professional, transparent and helpful throughout the entire
            process."
          </blockquote>

          <p className="mt-6 text-gray-400">— JamesAutos Customer</p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-yellow-500 py-20">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <Phone size={40} className="mx-auto text-black" />
          ...
          <p className="mx-auto mt-5 max-w-2xl text-black/70">
            Browse our collection or speak with our team today. Your next
            vehicle could be closer than you think.
          </p>
